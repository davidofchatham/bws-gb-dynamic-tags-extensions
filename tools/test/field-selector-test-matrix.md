...
| M3.4d | Any list, checking ORDER | Still alphabetical by field LABEL, NOT clustered by type — the sort key does not read the annotation. Two relationship fields called `Alpha` and `Zeta` stay either side of a text field called `Middle` |
