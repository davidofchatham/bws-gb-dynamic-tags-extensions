...
return array(
	...
	'posts' => array(
		...
		// the first one we refuse: a WooCommerce product record satisfies no arm of
		// bws_classify_loop_item(), so every bare tag of ours inside this loop renders
		// nothing. That refusal is the page's subject, not a defect in the fixture.
		//
