...
return array(
	...
	'posts' => array(
		...
		// Main phone matrix page: holds the full phone-format value set,
		// the src:ref relationship, and VALID department terms (R3.2).
		// Content generated by blocks.php (phone matrix sections).
		'page-phone-matrix' => array(
			'post_type'       => 'page',
			'post_name'       => 'phone-matrix',
			'post_title'      => 'Phone Matrix',
			'content_builder' => 'phone_matrix',
		),

		// Term-hop with one junk term among valid (R3.3).
		'page-phone-mixed-terms' => array(
			'post_type'       => 'page',
			'post_name'       => 'phone-mixed-terms',
			'post_title'      => 'Phone Mixed Terms',
			'content_builder' => 'phone_term_hop',
		),

		// Term-hop with ONLY junk terms → fallback fires (R3.4).
		'page-phone-junk-terms' => array(
			'post_type'       => 'page',
			'post_name'       => 'phone-junk-terms',
			'post_title'      => 'Phone Junk Terms',
			'content_builder' => 'phone_term_hop',
		),
	...
	'post_terms' => array(
		'page-phone-matrix'      => array( 'department-support', 'department-sales' ),
		'page-phone-mixed-terms' => array( 'department-support', 'department-sales', 'department-warehouse' ),
		'page-phone-junk-terms'  => array( 'department-warehouse' ),
	),
