...
return array(
	...
	'posts' => array(
		...
		//
		// Its bare-tag rows are seeded WRONG on purpose: they record the id leak as
		// it exists today, so the fix's snapshot diff is proof rather than assertion.
