...
Detail home: `.scratch/plans/field-selector.md` (v2, v-future, the FU follow-ups, §The KIND axis and §Offering protected or unregistered postmeta). The kind-axis build record is [PR #137](https://github.com/davidofchatham/bws-gb-dynamic-tags-extensions/pull/137), which published its spec on merge
