...
| ~~Function passthrough tag (`{{call}}`) — developer-tool 4th structural position~~ | **SHIPPED v1.12.0** | CHANGELOG 1.12.0 + `docs/tag-reference.md` §Call tag; CONTEXT.md §Registration-API load order (VC-load); design archived at `.claude/plans/archive/fn-passthrough-tag.md` |
