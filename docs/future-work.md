...
Blocked by: —  •  Interacts with: FW-13 (same detail home; its v2 prop set is what FU-2 waits on, per the Open line), FW-74 (its Location preset is FU-1's third round-tripping site), FW-81 (the datetime collapse more than halves FU-3's stacking), FW-53 ({{table}} lands FU-1 prior art + FU-3 second instance + FU-2 proposal)
