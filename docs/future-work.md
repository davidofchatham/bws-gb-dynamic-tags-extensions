...
Detail home: `CONTEXT.md` [I12] (the rule the `try_` half does not yet keep) + this row; FW-85's build record is the prior art for the shape, not a design for this one
