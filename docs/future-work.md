...
| FW-6 | datetime list mode | `limit` + `sep` on datetime. | — | FW-3 | GH #30 + #48 (spec); execution `.claude/plans/datetime-pass.md` |
...
| FW-12 | Custom time format on two-ended `as:time` range | | — | — | GH #25 + #48 (spec); execution `.claude/plans/datetime-pass.md` |
